...
class ProfileMenu extends React.Component {
  constructor() {
    ...
    this.handleClickOutsite = this.handleClickOutsite.bind(this);
  }
  ...
  render() {
    return (
      <section className="profile-menu">
        <img src="/img/vishu.jpg" onClick={this.handleClick} className="profile-btn medium-avatar" ref="profileBtn" />
        {
